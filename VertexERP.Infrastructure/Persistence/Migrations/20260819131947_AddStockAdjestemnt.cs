...
{
    /// <inheritdoc />
    public partial class AddStockAdjestemnt : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockAdjustments_Users_ApprovedByUserId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockAdjustments_Users_RejectedByUserId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockAdjustments_Users_RequestedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockAdjustments_RejectedByUserId",
                table: "StockAdjustments",
